...
public class SummonerClient {
    ...
    public static void postClientInitialize() {
        ...
        registerProperties(SummonerItems.SUMMON_BOW, new ResourceLocation("pulling"), (itemStack, clientLevel, livingEntity, i) -> livingEntity != null && livingEntity.isUsingItem() && livingEntity.getUseItem() == itemStack ? 1.0F : 0.0F);
    }
